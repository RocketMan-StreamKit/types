...
| Event | When | Payload |
| --- | --- | --- |
| `addon:prepare-stop` | Before the worker is killed (disable, uninstall, or app quit) | `{}` — finish remote cleanup; keep handlers short (~10s timeout). See [Lifecycle — Graceful stop](./lifecycle.md#graceful-stop--addonprepare-stop) |
