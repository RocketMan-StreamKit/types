...
| Подія | Коли | Payload |
| --- | --- | --- |
| `addon:prepare-stop` | Перед убивством worker (вимкнення, видалення або вихід із застосунку) | `{}` — завершіть віддалений cleanup; тримайте обробник коротким (~2.5 с таймаут). Див. [Життєвий цикл — Коректна зупинка](./lifecycle.md#коректна-зупинка--addonprepare-stop) |
