# Документація StreamKit+

Посібники для **стримерів** (як користуватися застосунком) і для **розробників аддонів** (API пісочниці, маніфест, дозволи).
...
Як користуватися StreamKit+ як настільним застосунком — не як писати аддони.

| Розділ | Опис |
| --- | --- |
| [Початок роботи](./user-getting-started.md) | Перший запуск, ліцензія, з чого складається застосунок |
| [Головне вікно](./user-main-window.md) | Таймер, швидкі дії, заголовок, статус |
| [Останні події](./user-events.md) | Жива стрічка подій і чипи повтору |
| [Вікно чату](./user-chat.md) | Спільний чат, відповіді, зовнішній вигляд |
| [Налаштування](./user-settings.md) | Бічна панель, збереження, Основні та Інтерфейс |
| [Аддони та каталог](./user-addons.md) | Установлення платформ, дозволи, оновлення |
| [Оверлей](./user-overlay.md) | Ефекти на екрані та в OBS |
| [Віджети та застосунки](./user-widgets.md) | Віджети OBS і вікна всередині застосунку |
| [Таймер донату](./user-timer.md) | Файли зворотного відліку та автоправила |
| [Звукові ефекти](./user-sounds.md) | Звуки сповіщення за подіями |
| [Хоткеї](./user-hotkeys.md) | Клавіатурний агент і пресети |
| [Спільна синхронізація](./user-coop-sync.md) | Оверлеї та хоткеї на інших ПК |
| [Ігрові інтеграції](./user-games.md) | Дії глядачів усередині гри |
| [Озвучення тексту](./user-tts.md) | Голоси Piper, ElevenLabs, Windows |
...
| [Резервні копії](./user-backup.md) | Zip-знімки та відновлення |

## Для розробників аддонів
