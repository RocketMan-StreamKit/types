...
| [network](./api-network.md) | HTTP-клієнт, ендпоінти, WebSocket, SSE, SignalR, Socket.IO |
...
| [Сповіщення (`alerts`)](./api-alerts.md) | Координація показу сповіщень між аддонами (без дозволу) |
| [Валюта](./api-currency.md) | Основна валюта користувача та конвертація сум |
| [Визначення мови (`language`)](./api-language.md) | Визначення мови тексту через fastText (~176 мов; без дозволу) |
