...
| `NETWORK_SSE` | Вихідний Server-Sent Events: `network.sse.connect` |
...
| `LLM` | LLM Access: `llm.chat`, `llm.listProfiles`, `llm.getSettings` (профілі LLM користувача; див. [LLM Access](./api-llm.md)) |
