# Документация StreamKit+

Руководства для **стримеров** (как пользоваться приложением) и для **разработчиков аддонов** (API песочницы, манифест, разрешения).
...
Как пользоваться StreamKit+ как настольным приложением — не как писать аддоны.

| Раздел | Описание |
| --- | --- |
| [Начало работы](./user-getting-started.md) | Первый запуск, лицензия, из чего состоит приложение |
| [Главное окно](./user-main-window.md) | Таймер, быстрые действия, заголовок, статус |
| [Последние события](./user-events.md) | Живая лента событий и чипы повтора |
| [Окно чата](./user-chat.md) | Общий чат, ответы, внешний вид |
| [Настройки](./user-settings.md) | Боковая панель, сохранение, Основные и Интерфейс |
| [Аддоны и каталог](./user-addons.md) | Установка платформ, разрешения, обновления |
| [Оверлей](./user-overlay.md) | Эффекты на экране и в OBS |
| [Виджеты и приложения](./user-widgets.md) | Виджеты OBS и окна внутри приложения |
| [Таймер доната](./user-timer.md) | Файлы обратного отсчёта и автоправила |
| [Звуковые эффекты](./user-sounds.md) | Звуки оповещения по событиям |
| [Хоткеи](./user-hotkeys.md) | Клавиатурный агент и пресеты |
| [Совместная синхронизация](./user-coop-sync.md) | Оверлеи и хоткеи на других ПК |
| [Игровые интеграции](./user-games.md) | Действия зрителей внутри игры |
| [Озвучка текста](./user-tts.md) | Голоса Piper, ElevenLabs, Windows |
...
| [Резервные копии](./user-backup.md) | Zip-снимки и восстановление |
