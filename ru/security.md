...
Неперехваченные ошибки вне этих обёрток по-прежнему могут уронить процесс воркера. После **3 последовательных падений** без стабильной работы автоперезапуск прекращается, пока пользователь не перезапустит аддон в настройках — см. [Жизненный цикл — Защита от цикла падений](./lifecycle.md#защита-от-цикла-падений).
